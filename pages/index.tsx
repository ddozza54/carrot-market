  ...
  return (
    <div className='bg-slate-400 py-10 px-10 grid gap-10 min-h-screen'>
      <div className='bg-white p-8 rounded-3xl shadow-md '>
        ...
        <ul className=''>
          {[1, 2].map((v, i) =>
            <div key={i} className='flex justify-between first:bg-blue-50 last:bg-blue-50'>
        ...
        <ul className=''>
          {[1, 2, 3, 4].map((v, i) =>
            <div key={i} className='flex justify-between even:bg-amber-500 odd:bg-green-300'>
              <span className='text-gray-500'>Gray Chair</span>
              <span className='font-semibold'> $19</span>
            </div>
          )
        ...
        <ul>
          {["a", "b", "c", ""].map((v, i) => <li key={i} className='bg-blue-200 py-4 empty:hidden'>{v}</li>)}
        </ul>
      ...
      <div className='bg-white p-6 rounded-3xl shadow-md '>
        ...
        <div className='flex flex-col'>
          ...
          <div className='flex justify-between'>
            ...
            <div className='space-x-4'>
              <button className='aspect-square w-8 rounded-lg font-medium bg-blue-200'>-</button>
        ...
        <div>
          <div className='flex items-center justify-between'>
            ...
            <button className=' bg-blue-500 font-semibold  text-white rounded-xl px-10 py-4'>Add to Chart</button>
          </div>
        </div>
      </div>
